...
SERIAL_PORT = '/dev/ttyAMA0' #Replace ttyS0 with ttyAM0 for Pi1,Pi2,Pi0. TNT0 is test virtual serial port
...
def set_power_led(bufferArray):
    ...
    #bufferArray[LED_MAP["program_running"]] = Color(0,255,128)
    #test = Color(0,255,128)
    #print(test)
